...
- Full iOS unit test suite: **441 passing** (+12 net for CheckInDraftEditTests, −4 removed HistoryNoteUpdateTests across the CRUD arc).
- Full iOS UI test suite: **16 passing** (+1 History→edit happy path).
