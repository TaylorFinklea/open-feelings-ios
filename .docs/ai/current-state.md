...
- Full iOS unit test suite: **429 passing** (+21 across the CRUD arc: CustomValues, CustomBodyRegion, CommittedActionDelete, PastSortsDelete, IntentionEdit/Delete).
- Full iOS UI test suite: **15 passing** (CRUD affordances have a11y identifiers but no XCUITest coverage yet).
